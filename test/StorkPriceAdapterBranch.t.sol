...
contract StorkPriceAdapterBranchTest is Test {
    ...
    function testInitializeGrantsAdminRole() public {
        ...
        StorkPriceAdapter freshAdapter = StorkPriceAdapter(address(new ERC1967Proxy(address(impl), abi.encodeWithSelector(StorkPriceAdapter.initialize.selector, newAdmin, address(stork)))));
    ...
    function testInitializeTwiceReverts() public {
        ...
        StorkPriceAdapter impl = new StorkPriceAdapter();
        StorkPriceAdapter freshAdapter = StorkPriceAdapter(address(new ERC1967Proxy(address(impl), abi.encodeWithSelector(StorkPriceAdapter.initialize.selector, admin, address(stork)))));
